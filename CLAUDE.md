...
| `check_gui_language.py` | Prüft, dass **alle sichtbaren Texte** in `bridge_gui.py`, `bridge_gui_modern.py`, `gui_term.py` und `gui_term_modern.py` englisch sind — über den Syntaxbaum, damit Kommentare unberührt bleiben |
