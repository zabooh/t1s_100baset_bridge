...
stored in bench.json next to this script, keyed on the probe's serial number, and read
back by flash.bat, so a plain "flash.bat" always programs the same board even when
